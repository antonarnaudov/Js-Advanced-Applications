...
const createTemplate = (onSubmit, errorMsg, isValid) => html `
    ...
    <div class="row space-top">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input class=${"form-control" + (isValid.make ? ' is-valid' : '') + (isValid.make === false ? ' is-invalid' : '')} id="new-make" type="text" name="make">
            </div>
            <div class="form-group has-success">
                <label class="form-control-label" for="new-model">Model</label>
                <input class=${"form-control" + (isValid.model ? ' is-valid' : '') + (isValid.model === false ? ' is-invalid' : '')} id="new-model" type="text" name="model">
            </div>
            <div class="form-group has-danger">
                <label class="form-control-label" for="new-year">Year</label>
                <input class=${"form-control" + (isValid.year ? ' is-valid' : '') + (isValid.year === false ? ' is-invalid' : '')} id="new-year" type="number" name="year">
            </div>
            <div class="form-group">
                <label class="form-control-label" for="new-description">Description</label>
                <input class=${"form-control" + (isValid.description ? ' is-valid' : '') + (isValid.description === false ? ' is-invalid' : '')} id="new-description" type="text" name="description">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label class="form-control-label" for="new-price">Price</label>
                <input class=${"form-control" + (isValid.price ? ' is-valid' : '') + (isValid.price === false ? ' is-invalid' : '')} id="new-price" type="number" name="price">
            </div>
            <div class="form-group">
                <label class="form-control-label" for="new-image">Image</label>
                <input class=${"form-control" + (isValid.img ? ' is-valid' : '') + (isValid.img === false ? ' is-invalid' : '')} id="new-image" type="text" name="img">
            </div>
            <div class="form-group">
